...
class GraphBlock(nn.Module):
    ...
    def forward(self, batch, query_vec, input_state=None, graph_state_dict=None):
        if input_state is not None:
            assert graph_state_dict is None
        ...
        ##############################################
        return input_state, graph_state, graph_state_dict, node_mask, sent_state, query_vec, para_logit, para_prediction, \
