...
preprocess() {
    ...
    for input in ${INPUTS[*]}; do
        ...
        echo "Error Analysis"
        python errorAnalysis/predictionAnalysis.py --raw_data $INPUT_FILE --input_dir $OUTPUT_FEAT --pred_dir $PRED_OUTPUT --output_dir $OUTPUT_FEAT --model_type roberta --model_name_or_path roberta-large --at_model_name_or_path roberta_large_test
