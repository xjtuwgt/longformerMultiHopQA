...
def compute_loss(args, batch, start, end, para, sent, ent, q_type):
    ...
    print('sent', sent_mask.shape)
    print('sent', sent_gold.shape)
    print('sent', query_sent_pred.shape)
    ...
    print('para', para_mask.shape)
    print('para', para_gold.shape)
    print('para', query_para_pred.shape)
    ####################################################################################################################
