                ...
                for sent_ner_id, (_, ent_start_char, ent_end_char, _) in enumerate(sent_ner):
                    ...
                    ctx_entity_start_end_position.append((ctx_char_to_word_offset[sent_start_char_id + ent_start_char],
                                                          ctx_char_to_word_offset[
                                                              sent_start_char_id + ent_end_char - 1]))
...
def convert_examples_to_longformer_features(examples, tokenizer, max_seq_length, max_query_length, max_entity_num, model_type,
                                 cls_token,
                                 sep_token,
                                 filter_no_ans=False):
    features = []
