...
TRANSFO_XL_START_DOCSTRING = r"""    The Transformer-XL model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.TransfoXLTokenizer`.
...
class TFTransfoXLModel(TFTransfoXLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import TransfoXLTokenizer, TFTransfoXLModel
...
class TFTransfoXLLMHeadModel(TFTransfoXLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import TransfoXLTokenizer, TFTransfoXLLMHeadModel
