...
CTRL_START_DOCSTRING = r"""    CTRL model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.CTRLConfig`): Model configuration class with all the parameters of the model.
...
CTRL_INPUTS_DOCSTRING = r"""    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.CTRLTokenizer`.
...
class TFCTRLModel(TFCTRLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import CTRLTokenizer, TFCTRLModel
...
class TFCTRLLMHeadModel(TFCTRLPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        from hgntransformers import CTRLTokenizer, TFCTRLLMHeadModel
