...
import hgntransformers.tokenization_transfo_xl as data_utils
from hgntransformers import (
    CONFIG_NAME,
    WEIGHTS_NAME,
    TransfoXLConfig,
...
from hgntransformers.tokenization_transfo_xl import CORPUS_NAME, VOCAB_FILES_NAMES
