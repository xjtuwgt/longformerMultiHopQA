...
from hgntransformers import SingleSentenceClassificationProcessor as Processor
from hgntransformers import TextClassificationPipeline, is_tf_available, is_torch_available
...
class TrainCommand(BaseTransformersCLICommand):
    ...
    def __init__(self, args: Namespace):
        self.logger = getLogger("hgntransformers-cli/training")
