...
from hgntransformers import Pipeline
from hgntransformers.commands import BaseTransformersCLICommand
from hgntransformers.pipelines import SUPPORTED_TASKS, pipeline
...
logger = logging.getLogger("hgntransformers-cli/serving")
