...
BERT_START_DOCSTRING = r"""    The BERT model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.BertConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the configuration.
            Check out the :meth:`~hgntransformers.PreTrainedModel.from_pretrained` method to load the model weights.
"""
...
BERT_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.BertTokenizer`.
            See :func:`hgntransformers.PreTrainedTokenizer.encode` and
            :func:`hgntransformers.PreTrainedTokenizer.convert_tokens_to_ids` for details.
...
class TFBertModel(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertModel
...
class TFBertForPreTraining(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForPreTraining
...
class TFBertForMaskedLM(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForMaskedLM
...
class TFBertForNextSentencePrediction(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForNextSentencePrediction
...
class TFBertForSequenceClassification(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForSequenceClassification
...
class TFBertForMultipleChoice(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForMultipleChoice
...
class TFBertForTokenClassification(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForTokenClassification
...
class TFBertForQuestionAnswering(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import BertTokenizer, TFBertForQuestionAnswering
