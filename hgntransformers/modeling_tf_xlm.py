...
XLM_START_DOCSTRING = r"""    The XLM model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.XLMConfig`): Model configuration class with all the parameters of the model.
...
XLM_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ```Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.XLMTokenizer`.
...
class TFXLMModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import XLMTokenizer, TFXLMModel
...
class TFXLMWithLMHeadModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import XLMTokenizer, TFXLMWithLMHeadModel
...
class TFXLMForSequenceClassification(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import XLMTokenizer, TFXLMForSequenceClassification
...
class TFXLMForQuestionAnsweringSimple(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import XLMTokenizer, TFXLMForQuestionAnsweringSimple
