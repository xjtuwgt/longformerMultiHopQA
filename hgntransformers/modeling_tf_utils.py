...
class TFPreTrainedModel(tf.keras.Model):
    r""" Base class for all TF models.
        ...
        :class:`~hgntransformers.TFPreTrainedModel` takes care of storing the configuration of the models and handles methods for loading/downloading/saving models
