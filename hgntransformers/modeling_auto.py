...
class AutoModel(object):
    r"""
        :class:`~hgntransformers.AutoModel` is a generic model class
...
class AutoModelWithLMHead(object):
    r"""
        :class:`~hgntransformers.AutoModelWithLMHead` is a generic model class
...
class AutoModelForSequenceClassification(object):
    r"""
        :class:`~hgntransformers.AutoModelForSequenceClassification` is a generic model class
...
class AutoModelForQuestionAnswering(object):
    r"""
        :class:`~hgntransformers.AutoModelForQuestionAnswering` is a generic model class
