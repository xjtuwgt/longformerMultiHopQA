...
T5_START_DOCSTRING = r"""    The T5 model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.T5Config`): Model configuration class with all the parameters of the model.
...
T5_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.T5Tokenizer`.
...
class TFT5Model(TFT5PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import T5Tokenizer, TFT5Model
...
class TFT5WithLMHeadModel(TFT5PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import T5Tokenizer, TFT5WithLMHeadModel
