...
from hgntransformers.configuration_albert import AlbertConfig
from hgntransformers.modeling_bert import ACT2FN, BertEmbeddings, BertSelfAttention, prune_linear_layer
from hgntransformers.modeling_utils import PreTrainedModel
...
ALBERT_START_DOCSTRING = r"""    The ALBERT model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.AlbertConfig`): Model configuration class with all the parameters of the model.
...
ALBERT_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.AlbertTokenizer`.
