...
OPENAI_GPT_START_DOCSTRING = r"""    OpenAI GPT model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""    Inputs:
        **input_ids**: ```Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`hgntransformers.BPT2Tokenizer`.
...
class TFOpenAIGPTModel(TFOpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import OpenAIGPTTokenizer, TFOpenAIGPTModel
...
class TFOpenAIGPTLMHeadModel(TFOpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import OpenAIGPTTokenizer, TFOpenAIGPTLMHeadModel
...
class TFOpenAIGPTDoubleHeadsModel(TFOpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import OpenAIGPTTokenizer, TFOpenAIGPTDoubleHeadsModel
