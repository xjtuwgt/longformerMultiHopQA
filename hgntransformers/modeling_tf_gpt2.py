...
GPT2_START_DOCSTRING = r"""    OpenAI GPT-2 model was proposed in
    ...
    Parameters:
        config (:class:`~hgntransformers.GPT2Config`): Model configuration class with all the parameters of the model.
...
class TFGPT2Model(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import GPT2Tokenizer, TFGPT2Model
...
class TFGPT2LMHeadModel(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import GPT2Tokenizer, TFGPT2LMHeadModel
...
class TFGPT2DoubleHeadsModel(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from hgntransformers import GPT2Tokenizer, TFGPT2DoubleHeadsModel
